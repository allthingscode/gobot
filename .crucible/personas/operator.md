...
Project-specific deployment and health-check commands come from `.crucible/config.yaml` (`verification.*` and any operator-relevant entries) and the project Operator override at `.crucible/personas/operator.md` if present.
</persona>
